...
An uppercase letter “X” will mark the current state of any given card. If more granular information is required, other marks may be used instead. For example, to indicate that the task is paused a “P” would be used. To indicate the progress within some stage a percentage would be used.
